      ...
      switch (arr[i]) {
        ...
        case "set_plus_minus_button":
          if (doc.getElementsByTagName("dl") && !/border_h1_plus/.test(h1str) && !/border_h1_minus/.test(h1str)) {
            ...
            dst += '<a class="border_h1_plus" title="Überschriften auf-klappen" href="javascript:void(0)" onclick="' + tem + '"> + </a>';
            tem = "top.bib.show_dds({frame_name:'" + name + "',show_idx:[-999]})";
            dst += '<a class="border_h1_minus" title="zu-klappen" href="javascript:void(0)" onclick="' + tem + '"> &minus; </a> ';
          }
          break;
        case "post_css":
